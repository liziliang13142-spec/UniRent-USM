...
// 🌟 使用相对路径，因为我们现在确定在这个层级：app/messages/page.tsx
          ...
          {initialPartnerId && !conversations.find(c => c.id === initialPartnerId) && (
            ...
            >
              <div className="flex justify-between items-start">
                <span className="font-black text-blue-600 text-sm italic">New Inquiry</span>
            ...
            conversations.map(chat => (
              ...
              >
                <div className="flex justify-between items-center mb-1">
                  <span className="font-black text-slate-800 text-sm uppercase tracking-tighter">
                    UID: {chat.id.substring(0, 8)}
                  </span>
          ...
          <>
            <div className="p-5 border-b bg-white flex items-center justify-between shadow-sm">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h3 className="font-black text-slate-900 text-lg uppercase tracking-tighter">Chatting Session</h3>
