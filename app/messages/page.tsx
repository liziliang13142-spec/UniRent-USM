...
export default function MessagesPage() {
  ...
  return (
    <div className="h-[calc(100dvh-64px)] overflow-hidden bg-slate-50 flex flex-col md:flex-row font-sans">
      
      {/* 左侧：对话列表 */}
      <div className={`w-full md:w-96 bg-white border-r border-slate-100 flex-col h-full ${selectedPartner ? 'hidden md:flex' : 'flex'}`}>
        <div className="p-8 border-b bg-slate-900 text-white shrink-0">
      ...
      <div className={`flex-1 flex flex-col h-full ${!selectedPartner ? 'hidden md:flex' : 'flex'}`}>
        {selectedPartner ? (
          <>
            ...
            <div className="bg-white flex flex-col border-t shadow-[0_-5px_20px_rgba(0,0,0,0.02)] z-10 shrink-0">
