  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-4 relative" style={{ backgroundImage: "url('/login.jpg')", backgroundSize: "cover", backgroundPosition: "center" }}>
      ...
      <div className="relative z-10 w-full max-w-md flex flex-col items-center">
        ...
        <Card className="w-full shadow-2xl border-none rounded-md overflow-hidden animate-in fade-in slide-in-from-bottom-2 text-black">
            ...
            {step === 0 ? (
              <form onSubmit={handleSignup} className="space-y-4">
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="relative">
                    ...
                    <Input placeholder="e.g. 212345 or user@gmail.com" className="pl-10 h-10 border-gray-200" value={identifier} onChange={(e) => setIdentifier(e.target.value)} required />
                  </div>
                </div>
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="relative">
                    ...
                    <Input type={showPassword ? "text" : "password"} placeholder="••••••••" className={`pl-10 pr-10 h-10 ${password !== "" && !isPasswordStrong ? "border-red-500 focus-visible:ring-red-500" : "border-gray-200"}`} value={password} onChange={(e) => setPassword(e.target.value)} required />
                  ...
                  {password !== "" && !isPasswordStrong && (
                    <div className="flex items-center gap-1 text-red-500 text-[10px] font-medium mt-1">
                      ...
                      <span>Password is too weak. Check requirements below.</span>
                    </div>
                  )}
                </div>
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="relative">
                    ...
                    <Input type={showConfirmPassword ? "text" : "password"} placeholder="Confirm your password" className={`pl-10 pr-10 h-10 ${confirmPassword !== "" && !isMatching ? "border-red-500 focus-visible:ring-red-500" : "border-gray-200"}`} value={confirmPassword} onChange={(e) => setConfirmPassword(e.target.value)} required />
                ...
                <div className="space-y-2 pt-1">
                  ...
                  <RadioGroup value={role} onValueChange={(value: "Tenant" | "Landlord") => setRole(value)} className="flex gap-4">
                    <div className="flex items-center space-x-2 bg-white border p-2.5 rounded-md flex-1 cursor-pointer border-gray-200">
                      ...
                      <Label htmlFor="tenant" className="cursor-pointer text-sm font-medium">Tenant</Label>
                    </div>
                    <div className="flex items-center space-x-2 bg-white border p-2.5 rounded-md flex-1 cursor-pointer border-gray-200">
                      <RadioGroupItem value="Landlord" id="landlord" />
                      <Label htmlFor="landlord" className="cursor-pointer text-sm font-medium">Landlord</Label>
                    </div>
                  </RadioGroup>
                </div>
              ...
              <form onSubmit={handleVerifyOTP} className="space-y-6 py-4">
                ...
                <div className="space-y-2">
                  <Input type="text" maxLength={6} placeholder="000000" className="text-center text-2xl tracking-[0.5em] font-bold h-14 border-gray-300 focus:border-blue-600" value={otpToken} onChange={(e) => setOtpToken(e.target.value)} required />
                </div>
