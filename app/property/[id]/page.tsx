...
export default function PropertyDetailsPage() {
  ...
  // 🌟 从 useProperty 中引入 addReview 函数
                ...
                <Dialog open={isViewingModalOpen} onOpenChange={setIsViewingModalOpen}>
                  ...
                  <DialogContent className="rounded-3xl max-w-sm bg-white/95 backdrop-blur-md border-none shadow-2xl">
                    ...
                    <div className="space-y-4 pt-4">
                      ...
                      <div className="space-y-1"><label className="text-[10px] font-black text-gray-400 uppercase ml-1">Proposed Date</label><Input type="date" className="h-11 rounded-xl bg-gray-50 border-gray-100" value={viewingForm.date} onChange={e => setViewingForm({...viewingForm, date: e.target.value})} /></div>
